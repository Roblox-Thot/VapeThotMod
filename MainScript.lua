...
if betterisfile("vape/CustomModules/6872274481.lua") and not readfile("vape/CustomModules/6872274481.lua"):find("--this is my anti delete watermark kekw") then delfile("vape/CustomModules/8560631822.lua") end
