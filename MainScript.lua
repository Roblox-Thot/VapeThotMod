...
local function vapeGithubRequest(scripturl)
	if shared.VapeDeveloper then
		...
		print("https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/"..readfile("vape/commithash.txt").."/"..scripturl)
		if not suc then
...
if betterisfile("vape/CustomModules/6872274481.lua") and not readfile("vape/CustomModules/6872274481.lua"):find("--this is my anti delete watermark kekw") then delfile("vape/CustomModules/6872274481.lua") end
...
if string.find(Guicode, "(10, 100)") then Guicode = game:HttpGet("https://raw.githubusercontent.com/Roblox-Thot/VapeThotMod/"..readfile("vape/RTcommithash.txt").."/gui.lua") end
